...
# Ahora se crean tres instancias (a, b, c) igual que alarms.
...
# Salida. Muestra las direcciones IP públicas de las instancias de la aplicación de Monitoring.
output "monitoring_public_ips" {
  description = "Public IP addresses for the monitoring service instances"
...
# Salida. Muestra las direcciones IP privadas de las instancias de la aplicación de Monitoring.
output "monitoring_private_ips" {
  description = "Private IP addresses for the monitoring service instances"
